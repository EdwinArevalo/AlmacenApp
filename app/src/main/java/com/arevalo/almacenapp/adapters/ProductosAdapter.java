package com.arevalo.almacenapp.adapters;
...
import com.arevalo.almacenapp.DetailActivity;
import com.arevalo.almacenapp.EditActivity;
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            ...
                            case R.id.edit_button:
                                Intent intent = new Intent(viewHolder.itemView.getContext(), EditActivity.class);
